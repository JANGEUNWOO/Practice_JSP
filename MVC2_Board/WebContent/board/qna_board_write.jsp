<!-- 파일명 : board폴더 아래 qna_board_write.jsp -->
		...
		<form action="boardWritePro.bo" method="post"
			...
			<tr>
				...
				<td class="td_right"><input name="BOARD_PASS" 
					type="password"	id="BOARD_PASS" required="required"/>
				</td>
			</tr>
			<tr>
				<td class="td_left"><label>제 목</label></td>
				<td class="td_right"><input name="BOARD_SUBJECT" 
					type="text"	id="BOARD_SUBJECT" required="required"/>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="td_right"><input name="BOARD_FILE" 
					type="file"	id="BOARD_FILE" required="required" />
				</td>
			</tr>
			</table>
