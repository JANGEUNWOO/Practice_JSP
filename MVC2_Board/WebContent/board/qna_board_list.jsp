	...
	<section id="listForm">
		...
		<table>
			...
			<tr>
				...
				<td><%System.out.println("articleList.get(i).getBOARD_NUM() : " + articleList.get(i).getBOARD_NUM()); %>
					<%if(articleList.get(i).getBOARD_RE_LEV()!=0){ %>
						 <%for(int a=0;a<=articleList.get(i).getBOARD_RE_LEV()*2;a++){ %>
							&nbsp; <%}
						 System.out.println("articleList.get(i).getBOARD_RE_LEV() : " + articleList.get(i).getBOARD_RE_LEV()); 
						 System.out.println("articleList.get(i).getBOARD_RE_LEV()*2 : " + articleList.get(i).getBOARD_RE_LEV()*2);					
							%> ▶ <%}
					else{ %> ▶ <%} %> <a href="boardDetail.bo?board_num=
